            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form role="form" action="{{ route('vendorForm') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice_no" name="invoice_no" value="{{old('invoice_no')}}" placeholder="invoice no">
                                                </div>
                                            ...
                                            <!--   <div class="col-4">
                                                 <div class="form-group">
                                                      <label for="parser">CVR Number</label>
                                                      <input type="text" class="form-control" id="cvr_number" name="cvr_number" value="old('cvr_number')}}" placeholder="cvr_number">
                                                  </div>
                                                  <div class="input-error"> $errors->first('cvr_number') }}</div>
                                            </div>-->
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice_date" name="invoice_date" value="{{old('invoice_date')}}" placeholder="invoice date">
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="vat" name="vat" value="{{old('vat')}}" placeholder="vat">
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="sub_total" name="sub_total" value="{{old('sub_total')}}" placeholder="sub total">
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="grand_total" name="grand_total" value="{{old('grand_total')}}" placeholder="grand total">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="products_start" name="products_start" value="{{old('products_start')}}" placeholder="products start">
                                                </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="products_end" name="products_end" value="{{old('products_end')}}" placeholder="products end">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="product_row_length" name="product_row_length" value="{{old('product_row_length')}}" placeholder="products row length">
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="products_columns" name="products_columns" value="{{old('products_columns','{"name":1,"product_no":2,"stock":3,"qty":4,"price":5,"product_total":6}')}}" placeholder='{"name":1,"product_no":2,"stock":3,"qty":4,"price":5,"product_total":6}'>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="file" value="{{old('file')}}" name="file" accept=".xlsx,.xls,.doc, .docx,.pdf,.PDF,.png,.jpg,.jpeg" >
                                    </div>
                                    <div class="input-error">{{ $errors->first('name') }}</div>
